define(
    ...
    function ($, Component, ko) {
        ...
        ko.extenders.maxDeliverLaterLength = function (target, maxLength) {
            var timer;
        ...
        return Component.extend({
            defaults: {
                template: 'ParamountVentures_DeliverLater/checkout/order-comment-block'
            },
            initialize: function() {
                this._super();
                var self = this;
                this.comment = ko.observable("").extend({maxDeliverLaterLength: this.getMaxLength()});
