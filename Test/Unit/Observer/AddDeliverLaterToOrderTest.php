<?php
namespace ParamountVentures\DeliverLater\Test\Unit\Observer;

use ParamountVentures\DeliverLater\Observer\AddDeliverLaterToOrder;
...
class AddDeliverLaterToOrderTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->observer = new AddDeliverLaterToOrder();
    }
    ...
    public function testExecute()
    {
        ...
        $quoteMock->expects($this->atLeastOnce())
            ->method('getData')
            ->with(DeliverLater::COMMENT_FIELD_NAME)
            ->willReturn($comment);
        
        $this->observer->execute($observerMock);

        $this->assertEquals($comment, $orderMock->getData(DeliverLater::COMMENT_FIELD_NAME));
    }
